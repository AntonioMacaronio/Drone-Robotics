        ...
        while run_controller_thread:
            ...
            if control_on and (pdrone_ud != drone_ud):
                if drone_ud < 0:
                    ...
                    drone.down(min([100, int(drone_ud)*-1]))
                else:
                ...
                if frame_count % 3 == 0:
                    ...
                    if keypoint_scores[0, 0] > .04:
                        ...
                        overlay_image = cv2.line(
                            overlay_image, (centerx, centery - 20), (nosex, nosey), (255, 255, 0), 2)
                        ...
                        if time.perf_counter() - PREV_PREDICT_TIME > MAX_PREDICT_TIME:
                            ...
                            # s=r
                            print(
                                '_+_+_+_++_+_+_+_+__+_+_+_+_+_+_+__+_+__+_+_+__+_+')
                            ...
                            keypoint_coords[0, 0, 0] = nosey
                            overlay_image = cv2.line(
                                display_image, (centerx, centery - 20), (nosex, nosey), (0, 0, 255), 2)
                            errorx = nosex - centerx
                            errory = nosey - centery - 20
                            if abs(errorx) > 20:
                                ctrl_out_cc = pid_cc(errorx)
                    ...
                    meanHeight = ((rightHipy - rightSholy) +
                                  (leftHipy - leftSholy))/2
                    desiredHeight = 70
                    ctrl_out_fb = 0
